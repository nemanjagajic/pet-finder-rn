...
import {POST_FOUND_PET, FETCH_PETS, FETCH_LOST_PETS, POST_LOST_PET} from './pet/constants'
import {postFoundPet, fetchPets, fetchLostPets, postLostPet} from "./pet/saga";
...
export default function* rootSaga() {
    yield all([
        ...
        takeLatest(POST_LOST_PET, postLostPet)
    ]);
}
